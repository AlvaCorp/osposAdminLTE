...
<div id="register_wrapper">
	<?php echo form_open("sales/change_mode", array('id'=>'mode_form')); ?>
		...
		{
		?>
			<a href="<?php echo site_url($controller_name . '/manage')?>"><div class="btn btn-primary btn-sm" id="sales_overview"><span><?php echo $this->lang->line('sales_takings'); ?><span></div></a>
		<?php
		}
		?>
		...
		array('class'=>'data-modal','data-toggle'=>'modal','data-target'=>'#myModal','title'=>$this->lang->line('sales_suspended_sales')));
		?>
	<?php echo form_close(); ?>
	...
	<?php echo form_open("sales/add", array('id'=>'add_item_form')); ?>
		...
		<div id="new_item_button_register" >
			...
			array('class'=>'data-modal','data-toggle'=>'modal','data-target'=>'#myModal','title'=>$this->lang->line('sales_new_item')));
			?>
		</div>
	<?php echo form_close(); ?>
...
<div id="overall_sale">
	...
	?>
		...
		<div style="margin-top: 5px; text-align: center;">
			...
			array('class'=>'data-modal','data-toggle'=>'modal','data-target'=>'#myModal','title'=>$this->lang->line('sales_new_customer')));
			?>
		</div>
