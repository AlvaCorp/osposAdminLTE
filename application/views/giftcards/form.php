		...
		<div class="modal-body" >
			...
			<?php echo form_open('giftcards/save/'.$giftcard_info->giftcard_id,array('id'=>'giftcard_form','class' => 'form-horizontal')); ?>
				<fieldset id="giftcard_basic_info" style="padding: 5px;">
					...
					<?php echo form_label($this->lang->line('giftcards_person_id').':', 'name',array('class'=>'control-label col-xs-4')); ?>
						<div class='col-xs-6'>
					...
					<div class="form-group">
					<?php echo form_label($this->lang->line('giftcards_giftcard_number').':', 'name',array('class'=>'required control-label col-xs-4')); ?>
						<div class='col-xs-6'>
						<?php echo form_input(array(
					...
					<div class="form-group">
					<?php echo form_label($this->lang->line('giftcards_card_value').':', 'name',array('class'=>'required control-label col-xs-4')); ?>
						<div class='col-xs-6'>
						<?php echo form_input(array(
							'name'=>'value',
							'id'=>'value',
