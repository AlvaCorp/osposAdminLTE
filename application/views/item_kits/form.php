		...
		<div class="modal-body" >				
			...
			<?php echo form_open('item_kits/save/'.$item_kit_info->item_kit_id,array('id'=>'item_kit_form','class' => 'form-horizontal')); ?>
				<fieldset id="item_kit_info">
					...
					<?php echo form_label($this->lang->line('item_kits_name').':', 'name',array('class'=>'required control-label col-xs-4')); ?>
						<div class='col-xs-6'>
					...
					<div class="form-group">
					<?php echo form_label($this->lang->line('item_kits_description').':', 'description',array('class'=>' control-label col-xs-4')); ?>
						<div class='col-xs-6'>
					...
					<div class="form-group">
					<?php echo form_label($this->lang->line('item_kits_add_item').':', 'item',array('class'=>'control-label col-xs-4')); ?>
						<div class='col-xs-6'>
							<?php echo form_input(array(
								'name'=>'item',
								'class'=>'form-control',
